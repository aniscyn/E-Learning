...
@include('admin.menu-adm')
    ...
    <div class="card">
    <h5 class="card-header font-weight bg-info" style="color: white;">Data Mata Pelajaran</h5>
    <div class="card-body">
    <a href="/admin/data-mapel/tambah"> <button type="button" class="btn btn-secondary"> Tambah Data Mata Pelajaran</button> </a>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center" width="10%">
            <a href="/admin/data-mapel/{{$mapel->id_mapel}}/ubah">
            <button type="button" class="btn btn-outline-primary"> Ubah </button></a></td>
            <td class="text-center" width="10%">

            <form action="/admin/data-mapel/{{$mapel->id_mapel}}/hapus" method="post">
            @csrf
            <button type="submit"  onclick="mapelFunction()" name="mapel" class="btn btn-outline-danger" > Hapus</button></td>
        </form>
