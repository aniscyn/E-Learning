...
@include('admin.menu-adm')
    ...
    placeholder="Masukkan NIS Siswa" onkeypress="return hanyaAngka(event)" required>
    </div>
    </div>
    ...
    <div class="col-10">
    <textarea class="form-control" placeholder="Masukkan Alamat" name="alamat_siswa" required> </textarea>
    </div>
    </div>
